...
class CsvImportTemplateDefinition {
  const CsvImportTemplateDefinition(
    this.type,
    this.id,
    this.label,
    this.description,
...
const csvImportTemplates = <CsvImportTemplateDefinition>[
  ...
  CsvImportTemplateDefinition(
    ImportTemplateType.envelopes,
    'envelopes',
    'Enveloppes',
    'Importer les noms des enveloppes budgétaires.',
  ...
  CsvImportTemplateDefinition(
    ImportTemplateType.expenses,
    'expenses',
    'Journal des dépenses',
    'Importer les dépenses historiques ou courantes.',
  ...
  CsvImportTemplateDefinition(
    ImportTemplateType.advances,
    'advances',
    'Avances',
    'Importer les avances entre personnes et leurs remboursements.',
  ...
  CsvImportTemplateDefinition(
    ImportTemplateType.historicalBalances,
    'historical_balances',
    'Soldes historiques',
    'Importer les soldes de référence des comptes ou enveloppes.',
  ...
  CsvImportTemplateDefinition(
    ImportTemplateType.goals,
    'goals',
    'Objectifs',
    'Importer les objectifs d’épargne et d’acquisition.',
    'template_objectifs.csv',
    [
      'external_id',
      'nom',
      'montant_cible_centimes',
      'montant_initial_centimes',
      'date_cible',
      'priorite',
      'statut',
    ],
...
CsvImportTemplateDefinition byType(ImportTemplateType type) =>
    csvImportTemplates.firstWhere((x) => x.type == type);
CsvImportTemplateDefinition? byId(String id) {
